...
NearbyLocation.create(name: 'B | Carnegie Park', land_id: elane.id, within_10: true)
NearbyLocation.create(name: 'C | Insurrection AleWorks', land_id: elane.id, within_10: true)
NearbyLocation.create(name: 'D | Professional and Amateur Pinball Association Headquarters', land_id: elane.id, within_10: true)
NearbyLocation.create(name: 'E | Marshalls', land_id: elane.id, within_10: true)
